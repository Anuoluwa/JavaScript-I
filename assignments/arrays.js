...
for(let id = 0; id < inventory.length; id++) {
    if(id == 33) {
        console.log(`Car 33 is a ${inventory[id].car_year} ${inventory[id].car_make} ${inventory[id].car_model}`);
    }
}
...
console.log(`The total number of cars older than 2001 is ${oldCars.length}`); 
